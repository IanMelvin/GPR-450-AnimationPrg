...
struct ec_DataVtable
{
	...
	void* (*biCubic   )(void* val_out, const void* vals[4], const a3real param0, const a3real param1, const a3real param2, const a3real param3, const a3real param4, const ec_DataVtable* funcs);
};
