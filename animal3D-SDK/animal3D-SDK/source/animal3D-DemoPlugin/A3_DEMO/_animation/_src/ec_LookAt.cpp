...
void ec_LookAt(a3_HierarchyState* hierarchyState, a3_DemoSceneObject characterObject, a3vec3 targetLocation, a3byte name[a3node_nameSize]) // name should equal "Neck" for xbot
{
